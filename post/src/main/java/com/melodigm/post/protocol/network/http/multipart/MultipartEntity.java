package com.melodigm.post.protocol.network.http.multipart;
...
public class MultipartEntity extends AbstractHttpEntity { 
    ...
    */ 
    ...
    private String partToString(StringPart part) {
    	String result = "";
    	...
    	if(parts != null) {
    		for(int i = 0; i < parts.length; i++) {
    			...
    			if(part instanceof StringPart) {
    				result += partToString((StringPart)part);
    			} else if(part instanceof FilePart) {
    				FilePart filePart = (FilePart)part;
    				result += filePart.getName() + "" + filePart.getSource().getFileName();
    			}
    		}
    	}
