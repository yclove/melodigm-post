...
public class MaterialCalendarView extends ViewGroup {
     ...
     */
    // YCLOVE - Calendar Tile Size Define 44 > 28
    public static final int DEFAULT_TILE_SIZE_DP = 28;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.icon_mini_rew);
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.icon_mini_fw);
            }
    ...
    private void setupChildren() {
        ...
        buttonFuture.setImageResource(R.drawable.icon_mini_fw);
