...
/**
 * YCNOTE - ViewPager Transformer
    try {
        mMainViewPager.setPageTransformer(true, new TransformerItem(CubeOutTransformer.class).clazz.newInstance());
    } catch (Exception e) {
        LogUtil.e("ViewPager Transformer : " + e.getMessage());
    }
*/
