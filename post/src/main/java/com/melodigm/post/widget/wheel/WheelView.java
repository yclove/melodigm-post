...
public class WheelView extends View {
	...
	protected int[] SHADOWS_COLORS = new int[] { 0xFF111111,
	...
	protected static final int DEF_VISIBLE_ITEMS = 9;
	...
	// Wheel drawables
	// YCLOVE : Wheel - 배경 이미지 투명으로 변경
	/*private int wheelBackground = R.drawable.wheel_bg;
	private int wheelForeground = R.drawable.wheel_val;*/
	protected int wheelBackground = android.R.color.transparent;
	protected int wheelForeground = android.R.color.transparent;
	...
	// Recycle
	protected WheelRecycle recycle = new WheelRecycle(this);

	protected int bgResourceId = R.drawable.wheel_bg;

	// Listeners
	protected List<OnWheelChangedListener> changingListeners = new LinkedList<OnWheelChangedListener>();
	protected List<OnWheelScrollListener> scrollingListeners = new LinkedList<OnWheelScrollListener>();
	protected List<OnWheelClickedListener> clickingListeners = new LinkedList<OnWheelClickedListener>();
	 ...
	 */
	protected int getDesiredHeight(LinearLayout layout) {
	 ...
	 */
	protected int calculateLayoutWidth(int widthSize, int mode) {
	...
	protected ItemsRange getItemsRange() {
		...
		if (scrollingOffset != 0) {
			...
			// YCLOVE - WheelView 스크롤 시 아이템이 사라지는 현상으로 인하여 주석 처리
	 ...
	 */
	protected boolean addViewItem(int index, boolean first) {
