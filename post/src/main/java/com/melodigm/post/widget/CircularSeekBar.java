...
public class CircularSeekBar extends View {
    ...
    protected static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(255, 0, 175, 213);
    ...
    protected static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.argb(0, 74, 138, 255);
