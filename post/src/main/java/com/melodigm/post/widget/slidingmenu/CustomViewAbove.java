...
import com.melodigm.post.widget.slidingmenu.SlidingMenu.OnClosedListener;
import com.melodigm.post.widget.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
		...
		if (dx == 0 && dy == 0) {
			...
			if (isMenuOpen()) {
				if (mOpenedListener != null)
					mOpenedListener.onOpen();
			} else {
				if (mClosedListener != null)
					mClosedListener.onClose();
			}
			return;
		}
	...
	public void drawFade(View content, Canvas canvas, float openPercent) {
	  final int alpha = (int) (mViewBehind.mFadeDegree * 255 * Math.abs(1-openPercent));
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		drawFade(this, canvas, (1 - getPercentOpen()));
	}
