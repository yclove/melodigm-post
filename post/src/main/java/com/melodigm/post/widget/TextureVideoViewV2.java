 ...
 * </ol>
 */
public class TextureVideoViewV2 extends TextureView implements MediaPlayerControl {
    ...
    public TextureVideoViewV2(Context context) {
        super(context);
        initVideoView();
    }

    public TextureVideoViewV2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initVideoView();
    }

    public TextureVideoViewV2(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(TextureVideoViewV2.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(TextureVideoViewV2.class.getName());
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            LogUtil.e("Unable to open content: " + mUri, ex);
    ...
    private OnErrorListener mErrorListener =
            new OnErrorListener() {
                public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
                    LogUtil.e("Error: " + framework_err + "," + impl_err);
                    mCurrentState = STATE_ERROR;
                    mTargetState = STATE_ERROR;
                    if (mMediaController != null) {
                        mMediaController.hide();
